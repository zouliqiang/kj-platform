...
<form class="layui-form" style="width:70%;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input  type="text"  class="layui-input" name="policyNo"  maxlength="100"   lay-verify="required">
        </div>
    </div>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input  type="text"  class="layui-input" name="noTotal"  maxlength="100" lay-verify="required|number">
        </div>
    </div>
    </div>
          <div class="layui-form-item">
     ...
     <div class="layui-form-item">
        <div class="layui-input-block">
            <button class="layui-btn" lay-submit="" lay-filter="addPolicyNo">保存</button>
...
<script>
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(addPolicyNo)",function(data){
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    if(res.success){
                        parent.layer.msg("保单号保存成功！",{time:1000},function(){
